...
static long console_write(struct exec_context *ctx, u64 address, u64 length)
  {
...
static int do_write_console(struct file* filep, char * buff, u32 count)
{
  ...
  return console_write(current, (u64)buff, (u64)count);
}
